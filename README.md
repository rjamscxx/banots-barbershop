...
A client goes to the booking page and walks through a short wizard: pick a service, pick a date and time, leave their name and number. Services run ₱100 to ₱230.
...
- **Clients** with a bit of history, including when they last came in
